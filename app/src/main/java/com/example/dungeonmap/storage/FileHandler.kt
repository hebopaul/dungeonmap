...
*/
    ...
    suspend fun getInternalStorageMapList(): List<InternalStorageImage>  {
    ...
    suspend fun getInternalStorageTokenList(): List<InternalStorageImage>  {
    ...
    private suspend fun saveTokenToInternal(bmp: Bitmap, fileName: String) {
    ...
    private suspend fun saveMapToInternal(bmp: Bitmap, fileName: String) {
    ...
    suspend fun importTokenFromDevice(imageUri: Uri?) {
        if (imageUri != null) {
            withContext(Dispatchers.IO){
                val bitmap: Bitmap =
    ...
    suspend fun importMapFromDevice(imageUri: Uri?) {
        if (imageUri != null) {
            withContext(Dispatchers.IO){
                val bitmap: Bitmap =
                    MediaStore.Images.Media.getBitmap(context.contentResolver, imageUri)
